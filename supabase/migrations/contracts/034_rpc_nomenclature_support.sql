-- ============================================================================
-- Update create_contract_transaction RPC — Nomenclature Support
-- Migration: contracts/034_rpc_nomenclature_support.sql
--
-- Depends on:
--   032_nomenclature_seed.sql        (nomenclature_id column + seed data)
--   033_nomenclature_denorm_columns  (nomenclature_code, nomenclature_name)
--
-- What changed vs 016_fix_create_contract_rpc.sql:
--   1. New DECLARE variables: v_nomenclature_id, v_nomenclature_code,
--      v_nomenclature_name
--   2. New STEP 3.3: Lookup nomenclature from m_category_details
--   3. INSERT now includes nomenclature_id, nomenclature_code,
--      nomenclature_name
--   4. Response now includes nomenclature_id, nomenclature_code,
--      nomenclature_name
--
-- Rollback: Re-apply 016_fix_create_contract_rpc.sql
-- ============================================================================
...
BEGIN
    ...
    -- ═══════════════════════════════════════════
    -- STEP 4: Insert contract (WITH computed_events + nomenclature)
    -- ═══════════════════════════════════════════
...
COMMENT ON FUNCTION create_contract_transaction IS 'Creates a contract with blocks, vendors, history, access, computed_events, and nomenclature in a single transaction';
