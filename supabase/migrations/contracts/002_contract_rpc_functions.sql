-- =============================================================
-- CONTRACT RPC FUNCTIONS (Batch 1 of 2)
-- Migration: contracts/002_contract_rpc_functions.sql
-- Functions: create_contract_transaction, get_contracts_list, get_contract_by_id
-- =============================================================

-- ─────────────────────────────────────────────────────────────
-- 1. create_contract_transaction
--    Atomic create: idempotency → sequence → contract → blocks → vendors → history
-- ─────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────
-- 3. get_contract_by_id
--    Single record with embedded blocks + vendors
--    SECURITY DEFINER for hot-path read
-- ─────────────────────────────────────────────────────────────
