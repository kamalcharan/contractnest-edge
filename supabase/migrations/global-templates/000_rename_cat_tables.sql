-- ============================================================================
-- GLOBAL TEMPLATES: Step 0 - Rename cat_blocks → m_cat_blocks, cat_templates → t_cat_templates
-- ============================================================================
...
--   ALTER TABLE t_cat_templates RENAME TO cat_templates;
-- ============================================================================

-- Step 1: Rename tables
ALTER TABLE IF EXISTS cat_blocks RENAME TO m_cat_blocks;
ALTER TABLE IF EXISTS cat_templates RENAME TO t_cat_templates;
...
COMMENT ON TABLE t_cat_templates IS 'Master catalog templates - reusable contract template assemblies (renamed from cat_templates)';
...
BEGIN
  ...
  END IF;
  RAISE NOTICE 'SUCCESS: Tables renamed - cat_blocks → m_cat_blocks, cat_templates → t_cat_templates';
END $$;
